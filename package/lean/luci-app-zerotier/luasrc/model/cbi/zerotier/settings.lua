...
e=t:option(DummyValue,"opennewwindow" , 
	translate("<input type=\"button\" class=\"cbi-button cbi-button-apply\" value=\"Restart Zerotier\" onclick=\"window.open('/cgi-bin/luci/admin/vpn/zerotier/moon','_self')\" />"))
...
e=t:option(DynamicList,"moon",translate('ZeroTier MOON ID'))
e.password=true
e.rmempty=false
